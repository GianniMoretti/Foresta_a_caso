...
dataframe_name = r"C:\Users\jinnw\Desktop\Code\Foresta_a_caso\database\covtype.data"
...
for value in range(1, 21, 5):
    ...
    for i in range(N_p_value):
        ...
        skrf = RandomForestClassifier(n_estimators=value, criterion=criterion_type, max_depth=2, min_samples_split=2, max_features=7) 
        ...
        mrf = MyRandomForestClassifier(tree_num=value, max_samples=1, criterion=criterion_type, min_sample_split=2, max_depth=2, num_of_feature_on_split=7) 
